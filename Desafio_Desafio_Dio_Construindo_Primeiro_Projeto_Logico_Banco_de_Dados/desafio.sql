...
-- Criando tabela de Fornecimento de produto
...
-- Criando tabela de Estoque do produto
...
-- Criando tabela de Produtos nos Pedidos
...
-- Criando tabela de vendedores terceiros
...
-- Criando tabela de Produto por Vendedor
